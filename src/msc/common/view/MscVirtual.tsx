...
import {BaseMscVirtual, MscViewMortiseConfig, MscViewProxy, MscStateEvent} from "@mortiseai/mai_msc_engine_ts_module";

/**
 * 默认兜底 Virtual
 */
export class MscVirtual extends BaseMscVirtual {
